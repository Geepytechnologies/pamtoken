  ...
  return (
    <div className=" w-full h-[500px] mt-[160px] relative">
      ...
      <div className="absolute top-0">
        <div className="flex flex-col w-full gap-[64px]  items-center justify-center">
          <div className="flex flex-col gap-[16px]">
            <p className="text-[#F6F6F6] text-center font-[700] leading-[100%] text-[80px]">
              The diamond hand meme token
            </p>
            <p className="text-[#F6F6F6] text-2xl font-[600] text-center">

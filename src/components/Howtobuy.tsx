...
const Howtobuy = (props: Props) => {
  return (
    <div className="w-full h-[1000px] lg:h-[500px] relative">
      {/* <div className="w-full h-[1000px] lg:h-[500px] absolute top-0 bg-[rgba(0,0,0,0.7)]"></div> */}
      <div className="absolute h-full top-0 flex flex-col w-full ">
        ...
        <div className="flex w-full flex-[3] gap-5 lg:gap-9 flex-col lg:flex-row items-center justify-center text-white">
          {/* step 1 */}
          <motion.div
            initial={{
              opacity: 0,

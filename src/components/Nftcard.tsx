...
const Nftcard = ({ title, subtitle, image, type }: Infts) => {
  const Getnfts = () => {
    return (
      <div className="nftcard nfts-slide flex flex-col items-center justify-center min-w-[400px] h-[550px]">
  ...
  return (
    <>
      {type == "getnft" ? (
        ...
        <div className="nftcard nfts-slide flex flex-col min-w-[400px] h-[550px]">
